...
export const ja: Dict = {
  ...
  'fileViewer.exportPdfSuccess': 'PDFのエクスポートに成功しました',
  'fileViewer.exportZipSuccess': 'ZIPのダウンロードに成功しました',
  'fileViewer.exportHtmlSuccess': 'HTMLのエクスポートに成功しました',
  'fileViewer.exportMdSuccess': 'Markdownのエクスポートに成功しました',
