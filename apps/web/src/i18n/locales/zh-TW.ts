...
export const zhTW: Dict = {
  ...
  'routines.title': '自動化',
  'routines.subtitle': '無需值守的定時自動化作業。',
  'routines.newAutomation': '新增自動化',
  'routines.loading': '載入中…',
  'routines.empty': '尚無自動化作業',
  'routines.emptyHint': '按一下「新增自動化」來安排一次無人值守的代理執行。',
  'routines.runHistoryLoading': '載入執行歷史…',
  'routines.runHistoryEmpty': '尚無執行記錄。',
  'routines.fieldName': '名稱',
  'routines.fieldNamePlaceholder': '晨間簡報',
  'routines.fieldPrompt': '提示詞',
  'routines.fieldPromptPlaceholder': '描述自動化作業應執行的工作…',
  'routines.fieldSchedule': '排程',
  'routines.fieldMinute': '每小時的第幾分',
  'routines.fieldTime': '時間',
  'routines.fieldTimezone': '時區',
  'routines.fieldsetProject': '專案',
  'routines.kind.hourly': '每小時',
  ...
  'routines.weekday.short.1': '一',
  'routines.weekday.short.2': '二',
  'routines.weekday.short.3': '三',
  'routines.weekday.short.4': '四',
  'routines.weekday.short.5': '五',
  'routines.weekday.short.6': '六',
};
