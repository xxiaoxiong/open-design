...
export const tr: Dict = {
  ...
  'fileViewer.exportPdfSuccess': 'PDF başarıyla dışa aktarıldı',
  'fileViewer.exportZipSuccess': 'ZIP başarıyla indirildi',
  'fileViewer.exportHtmlSuccess': 'HTML başarıyla dışa aktarıldı',
  'fileViewer.exportMdSuccess': 'Markdown başarıyla dışa aktarıldı',
