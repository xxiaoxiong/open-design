...
export const uk: Dict = {
  ...
  'fileViewer.exportPdfSuccess': 'PDF успішно експортовано',
  'fileViewer.exportZipSuccess': 'ZIP успішно завантажено',
  'fileViewer.exportHtmlSuccess': 'HTML успішно експортовано',
  'fileViewer.exportMdSuccess': 'Markdown успішно експортовано',
