...
export const th: Dict = {
  ...
  'fileViewer.exportPdfSuccess': 'ส่งออก PDF สำเร็จ',
  'fileViewer.exportZipSuccess': 'ดาวน์โหลด ZIP สำเร็จ',
  'fileViewer.exportHtmlSuccess': 'ส่งออก HTML สำเร็จ',
  'fileViewer.exportMdSuccess': 'ส่งออก Markdown สำเร็จ',
