...
export const fr: Dict = {
  ...
  'routines.summaryAria': 'Automation summary',
  'routines.runNowTitle': 'Run now and open the conversation',
  'routines.deleteAria': 'Delete automation',
  'routines.evolutionProposalsAria': 'Automation evolution proposals',
  'routines.templatePlaceholder': 'Decision, brand notes, workflow pattern...',
  'routines.sourcePlaceholder': 'URL, repo path, connector event id, artifact id...',
  'routines.ingestPlaceholder': 'Paste the content to canonicalize into a source packet and proposals.',
  'routines.recentPacketsAria': 'Recent source packets',
  'routines.templateFiltersAria': 'Template filters',
  'routines.runHistoryAria': 'Automation run history',
  'routines.draftProposalsTitle': 'Draft skill and memory proposals from this run',
