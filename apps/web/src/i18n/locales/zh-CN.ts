...
export const zhCN: Dict = {
  ...
  'designFiles.sending': '发送中…',
  'designFiles.pluginReady': '插件已就绪',
  'designFiles.pluginReadySubtitle': '发送下一步指令给 Agent，让它运行 od CLI。',
  'designFiles.filesReadyForPlugins': '{count} 个文件已准备好添加到我的插件',
  'designFiles.openManifest': '打开清单文件',
