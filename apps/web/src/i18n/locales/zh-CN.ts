...
export const zhCN: Dict = {
  ...
  // Automations page
  'automations.hero.eyebrow': '自动化',
  'automations.hero.title': '定时任务',
  'automations.hero.description': '按计划或手动运行 AI 对话。',
  'automations.metrics.active': '活跃',
  'automations.metrics.paused': '已暂停',
  'automations.metrics.templates': '模板',
  'automations.actions.newAutomation': '新建自动化',
  'automations.saved.title': '你的自动化',
  'automations.saved.loading': '加载中…',
  'automations.saved.empty.title': '暂无自动化',
  'automations.saved.empty.description': '创建你的第一个自动化任务。',
  'automations.saved.targetNewProject': '新项目',
  'automations.saved.runNowTitle': '立即运行并打开对话',
  'automations.saved.actions.run': '立即运行',
  'automations.saved.actions.hideHistory': '隐藏历史',
  'automations.saved.actions.history': '历史记录',
  'automations.saved.actions.edit': '编辑',
  'automations.saved.actions.pause': '暂停',
  'automations.saved.actions.resume': '恢复',
  'automations.saved.actions.deleteAriaLabel': '删除自动化',
  'automations.saved.actions.deleteTitle': '删除此自动化？',
  'automations.saved.lastRun': '上次运行',
  'automations.saved.actions.openResult': '打开项目',
  'automations.proposals.title': '待审核提案',
  'automations.proposals.description': '在应用自动化生成的提案前进行审核。',
  'automations.proposals.pending': '待审核',
  'automations.proposals.actions.apply': '应用',
  'automations.proposals.actions.reject': '拒绝',
  ...
  'automations.proposals.target.automationTemplate': '自动化模板',
  ...
  'automations.proposals.action.promote': '提升',
  'automations.ingest.title': '导入源',
  'automations.ingest.description': '粘贴内容以导入到记忆或设计系统。',
  'automations.ingest.recent': '最近的数据包',
  'automations.ingest.fields.template': '模板',
  'automations.ingest.fields.source': '来源',
  'automations.ingest.fields.compression': '压缩',
  'automations.ingest.fields.connector': '连接器',
  'automations.ingest.fields.connectorAny': '任意连接器',
  'automations.ingest.fields.title': '标题',
  'automations.ingest.fields.titlePlaceholder': '可选标题',
  'automations.ingest.fields.sourceRef': '源引用',
  'automations.ingest.fields.sourceRefPlaceholder': 'URL、文件路径或标识符',
  'automations.ingest.fields.content': '内容',
  'automations.ingest.fields.contentPlaceholder': '在此粘贴内容…',
  'automations.ingest.empty': '暂无最近的数据包',
  'automations.ingest.actions.ingesting': '导入中…',
  'automations.ingest.actions.ingest': '导入',
  'automations.templates.title': '自动化模板',
  'automations.templates.description': '从模板开始或创建你自己的。',
  'automations.templates.filtersAriaLabel': '筛选模板',
  'automations.templates.empty.title': '无匹配模板',
  'automations.templates.empty.description': '尝试其他筛选条件。',
  'automations.templates.card.cta': '使用模板',
  'automations.history.loading': '加载历史记录…',
  'automations.history.empty': '暂无运行记录',
  'automations.history.title': '运行历史',
  'automations.history.latest': '最新',
  'automations.history.crystallizeTitle': '将此次运行保存为可复用模板',
  'automations.history.actions.crystallizing': '结晶化中…',
  'automations.history.actions.crystallize': '结晶化',
  'automations.history.actions.openConversation': '打开对话',
  'automations.status.paused': '已暂停',
  'automations.status.manualOnly': '仅手动',
  'automations.status.scheduled': '已计划',
  'automations.status.nextPrefix': '下次',
  'automations.status.inProgress': '进行中',
  'automations.status.succeeded': '成功',
  'automations.status.failed': '失败',
  'automations.status.running': '运行中',
  'automations.status.queued': '队列中',
  'automations.status.canceled': '已取消',
  'automations.kind.orbit': 'Orbit',
  'automations.kind.liveArtifact': '实时制品',
  'automations.kind.automation': '自动化',
  'automations.filters.all': '全部',
  'automations.filters.orbit': 'Orbit',
  'automations.filters.liveArtifacts': '实时制品',
  'automations.filters.memory': '记忆',
  'automations.filters.designSystems': '设计系统',
  'automations.filters.skills': '技能',
  'automations.filters.connectors': '连接器',
  'automations.filters.compression': '压缩',
  'automations.filters.release': '发布',
  'automations.filters.quality': '质量',
  'automations.sourceKind.connector': '连接器',
  'automations.sourceKind.url': 'URL',
  'automations.sourceKind.repo': '仓库',
  'automations.sourceKind.artifact': '制品',
  'automations.sourceKind.chat': '对话',
  'automations.sourceKind.upload': '上传',
  'automations.compression.balanced': '平衡',
  'automations.compression.aggressive': '激进',
  'automations.compression.off': '关闭',
  'automations.confirmDelete': '删除此自动化？',
  'automations.errors.emptyContent': '请先粘贴源内容再导入。',
  'automations.ariaLabels.summary': '自动化摘要',
  'automations.ariaLabels.yourAutomations': '你的自动化',
  'automations.ariaLabels.proposals': '待审核提案',
  'automations.ariaLabels.ingest': '导入源',
  'automations.ariaLabels.recentPackets': '最近的数据包',
  'automations.ariaLabels.templates': '自动化模板',
  'automations.ariaLabels.runHistory': '运行历史',
