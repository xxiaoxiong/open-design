...
export const zhCN: Dict = {
  ...
  // Routines
  'routines.title': '例行任务',
  'routines.description': '定时、无人值守的 Agent 会话。每次运行都会开启新对话——可以在现有项目中，也可以在即时创建的新项目中。',
  'routines.newRoutine': '新建例行任务',
  'routines.runNow': '立即运行',
  'routines.pause': '暂停',
  'routines.resume': '恢复',
  'routines.history': '历史记录',
  'routines.hideHistory': '隐藏历史',
  'routines.delete': '删除',
  'routines.save': '保存',
  'routines.cancel': '取消',
  ...
  'routines.project': '项目',
  'routines.newProject': '新项目',
  'routines.existingProject': '现有项目',
  'routines.hourly': '每小时',
  'routines.daily': '每天',
  'routines.weekdays': '工作日',
  'routines.weekly': '每周',
  'routines.minuteOfHour': '每小时的分钟数',
  'routines.hour': '小时',
  'routines.dayOfWeek': '星期',
  'routines.time': '时间',
  'routines.sunday': '星期日',
  'routines.monday': '星期一',
  'routines.tuesday': '星期二',
  'routines.wednesday': '星期三',
  'routines.thursday': '星期四',
  'routines.friday': '星期五',
  'routines.saturday': '星期六',
  'routines.sun': '周日',
  'routines.mon': '周一',
  'routines.tue': '周二',
  'routines.wed': '周三',
  ...
  'routines.fri': '周五',
  'routines.sat': '周六',
  'routines.succeeded': '成功',
  'routines.failed': '失败',
  'routines.running': '运行中',
  'routines.cancelled': '已取消',
  'routines.loadingRuns': '加载运行记录…',
  'routines.noRuns': '暂无运行记录。',
  'routines.manual': '手动',
  'routines.scheduled': '定时',
  'routines.last': '最近：',
  'routines.deleteConfirm': '删除此例行任务？过往运行记录及其项目将保留。',
  'routines.deleteTitle': '删除此例行任务',
  'routines.placeholderName': '晨间简报',
  'routines.loading': '加载中…',
  'routines.noRoutinesYet': '暂无例行任务。',
  'routines.noRoutinesHint': '点击"新建例行任务"来安排无人值守的 Agent 运行。',
