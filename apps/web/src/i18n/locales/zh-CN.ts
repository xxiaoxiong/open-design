...
export const zhCN: Dict = {
  ...
  'fileViewer.exportPdfSuccess': 'PDF 导出成功',
  'fileViewer.exportPdfError': 'PDF 导出失败',
  'fileViewer.exportZipSuccess': 'ZIP 下载成功',
  'fileViewer.exportZipError': 'ZIP 下载失败',
  'fileViewer.exportHtmlSuccess': 'HTML 导出成功',
  'fileViewer.exportMdSuccess': 'Markdown 导出成功',
