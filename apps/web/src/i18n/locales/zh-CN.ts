...
export const zhCN: Dict = {
  ...
  'designs.bulkDelete.button': '删除 {count} 个',
  'designs.bulkDelete.selectAll': '全选',
  'designs.bulkDelete.deselectAll': '取消全选',
  'designs.bulkDelete.confirm.title': '确定删除 {count} 个项目？',
  'designs.bulkDelete.confirm.message': '此操作无法撤销。',
  'designs.bulkDelete.confirm.list': '将要删除的项目：',
  'designs.bulkDelete.success': '已成功删除 {count} 个项目',
  'designs.bulkDelete.partialFailure': '已删除 {success}/{total} 个项目',
