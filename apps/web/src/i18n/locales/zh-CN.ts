...
export const zhCN: Dict = {
  ...
  'routines.yourAutomations': '您的自动化',
  'routines.emptyTitle': '还没有自动化任务',
  'routines.emptyBody': '从模板创建一个，或从空白计划开始。',
  'routines.newProjectEachRun': '每次运行新建项目',
  'routines.metricActive': '活跃',
  'routines.metricPaused': '已暂停',
  'routines.metricTemplates': '模板',
  'routines.ingestSourceTitle': '导入来源',
  'routines.ingestSourceDescription': '将连接器、仓库、制品或聊天上下文转换为可审查的演进提案。',
  'routines.ingestSourceRecent': '最近',
  'routines.ingestTemplate': '模板',
  'routines.ingestSource': '来源',
  'routines.ingestCompression': '压缩',
  'routines.templatesTitle': '模板',
  'routines.summaryAria': '自动化摘要',
  'routines.runNowTitle': '立即运行并打开对话',
  'routines.deleteAria': '删除自动化',
  'routines.evolutionProposalsAria': '自动化演进提案',
  'routines.templatePlaceholder': '决策、品牌说明、工作流模式...',
  'routines.sourcePlaceholder': 'URL、仓库路径、连接器事件 ID、制品 ID...',
  'routines.ingestPlaceholder': '粘贴要规范化为源数据包和提案的内容。',
  'routines.recentPacketsAria': '最近的源数据包',
  'routines.templateFiltersAria': '模板筛选器',
  'routines.runHistoryAria': '自动化运行历史',
  'routines.draftProposalsTitle': '从此次运行草拟技能和记忆提案',
  'entry.helpAria': '帮助',
