...
export const en: Dict = {
  ...
  // Automations page
  'automations.hero.eyebrow': 'Automations',
  'automations.hero.title': 'Scheduled routines',
  'automations.hero.description': 'Run agent conversations on a schedule or manually.',
  'automations.metrics.active': 'Active',
  'automations.metrics.paused': 'Paused',
  'automations.metrics.templates': 'Templates',
  'automations.actions.newAutomation': 'New automation',
  'automations.saved.title': 'Your automations',
  'automations.saved.loading': 'Loading automations…',
  'automations.saved.empty.title': 'No automations yet',
  'automations.saved.empty.description': 'Create your first automation to get started.',
  'automations.saved.targetNewProject': 'New project',
  'automations.saved.runNowTitle': 'Run now and open the conversation',
  'automations.saved.actions.run': 'Run now',
  'automations.saved.actions.hideHistory': 'Hide history',
  'automations.saved.actions.history': 'History',
  'automations.saved.actions.edit': 'Edit',
  'automations.saved.actions.pause': 'Pause',
  'automations.saved.actions.resume': 'Resume',
  'automations.saved.actions.deleteAriaLabel': 'Delete automation',
  'automations.saved.actions.deleteTitle': 'Delete this automation?',
  'automations.saved.lastRun': 'Last run',
  'automations.saved.actions.openResult': 'Open project',
  'automations.proposals.title': 'Pending proposals',
  'automations.proposals.description': 'Review automation-generated proposals before applying them.',
  'automations.proposals.pending': 'pending',
  'automations.proposals.actions.apply': 'Apply',
  'automations.proposals.actions.reject': 'Reject',
  ...
  'automations.proposals.target.automationTemplate': 'Automation template',
  ...
  'automations.ingest.description': 'Paste content to ingest into memory or design systems.',
  'automations.ingest.recent': 'Recent packets',
  'automations.ingest.fields.template': 'Template',
  'automations.ingest.fields.source': 'Source',
  'automations.ingest.fields.compression': 'Compression',
  'automations.ingest.fields.connector': 'Connector',
  'automations.ingest.fields.connectorAny': 'Any connector',
  'automations.ingest.fields.title': 'Title',
  'automations.ingest.fields.titlePlaceholder': 'Optional title',
  'automations.ingest.fields.sourceRef': 'Source reference',
  'automations.ingest.fields.sourceRefPlaceholder': 'URL, file path, or identifier',
  'automations.ingest.fields.content': 'Content',
  'automations.ingest.fields.contentPlaceholder': 'Paste content here…',
  'automations.ingest.empty': 'No recent packets',
  'automations.ingest.actions.ingesting': 'Ingesting…',
  'automations.ingest.actions.ingest': 'Ingest',
  'automations.templates.title': 'Automation templates',
  'automations.templates.description': 'Start from a template or create your own.',
  'automations.templates.filtersAriaLabel': 'Filter templates',
  'automations.templates.empty.title': 'No templates match',
  'automations.templates.empty.description': 'Try a different filter.',
  'automations.templates.card.cta': 'Use template',
  'automations.history.loading': 'Loading history…',
  'automations.history.empty': 'No runs yet',
  'automations.history.title': 'Run history',
  'automations.history.latest': 'Latest',
  'automations.history.crystallizeTitle': 'Save this run as a reusable template',
  'automations.history.actions.crystallizing': 'Crystallizing…',
  'automations.history.actions.crystallize': 'Crystallize',
  'automations.history.actions.openConversation': 'Open conversation',
  'automations.status.paused': 'Paused',
  'automations.status.manualOnly': 'Manual only',
  'automations.status.scheduled': 'Scheduled',
  'automations.status.nextPrefix': 'Next',
  'automations.status.inProgress': 'In progress',
  ...
  'automations.kind.orbit': 'Orbit',
  'automations.kind.liveArtifact': 'Live artifact',
  'automations.kind.automation': 'Automation',
  'automations.filters.all': 'All',
  'automations.filters.orbit': 'Orbit',
  'automations.filters.liveArtifacts': 'Live artifacts',
  'automations.filters.memory': 'Memory',
  'automations.filters.designSystems': 'Design systems',
  'automations.filters.skills': 'Skills',
  'automations.filters.connectors': 'Connectors',
  'automations.filters.compression': 'Compression',
  'automations.filters.release': 'Release',
  'automations.filters.quality': 'Quality',
  'automations.sourceKind.connector': 'Connector',
  'automations.sourceKind.url': 'URL',
  'automations.sourceKind.repo': 'Repo',
  'automations.sourceKind.artifact': 'Artifact',
  'automations.sourceKind.chat': 'Chat',
  'automations.sourceKind.upload': 'Upload',
  ...
  'automations.errors.emptyContent': 'Paste source content before ingesting it.',
  'automations.ariaLabels.summary': 'Automation summary',
  'automations.ariaLabels.yourAutomations': 'Your automations',
  'automations.ariaLabels.proposals': 'Pending proposals',
  'automations.ariaLabels.ingest': 'Ingest source',
  'automations.ariaLabels.recentPackets': 'Recent packets',
  'automations.ariaLabels.templates': 'Automation templates',
  'automations.ariaLabels.runHistory': 'Run history',
