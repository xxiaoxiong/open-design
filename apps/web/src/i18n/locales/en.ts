...
export const en: Dict = {
  ...
  'designs.bulkDelete.button': 'Delete {count}',
  'designs.bulkDelete.selectAll': 'Select all',
  'designs.bulkDelete.deselectAll': 'Deselect all',
  'designs.bulkDelete.confirm.title': 'Delete {count} project(s)?',
  'designs.bulkDelete.confirm.message': 'This action cannot be undone.',
  'designs.bulkDelete.confirm.list': 'Projects to delete:',
  'designs.bulkDelete.success': '{count} project(s) deleted successfully',
  'designs.bulkDelete.partialFailure': '{success} of {total} project(s) deleted',
