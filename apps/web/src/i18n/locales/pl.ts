...
export const pl: Dict = {
  ...
  'routines.description': 'Scheduled, unattended agent sessions. Each run starts a new conversation — either inside an existing project, or in a fresh project minted on the spot.',
  ...
  'routines.newProject': 'New project',
  'routines.existingProject': 'Existing project',
  'routines.hourly': 'Hourly',
  'routines.daily': 'Daily',
  'routines.weekdays': 'Weekdays',
  'routines.weekly': 'Weekly',
  'routines.minuteOfHour': 'Minute of every hour',
  'routines.hour': 'Hour',
  'routines.dayOfWeek': 'Day of week',
  'routines.time': 'Time',
  'routines.sunday': 'Sunday',
  'routines.monday': 'Monday',
  'routines.tuesday': 'Tuesday',
  'routines.wednesday': 'Wednesday',
  'routines.thursday': 'Thursday',
  'routines.friday': 'Friday',
  'routines.saturday': 'Saturday',
  'routines.sun': 'Sun',
  'routines.mon': 'Mon',
  'routines.tue': 'Tue',
  'routines.wed': 'Wed',
  ...
  'routines.fri': 'Fri',
  'routines.sat': 'Sat',
  'routines.succeeded': 'succeeded',
  'routines.failed': 'failed',
  'routines.running': 'running',
  'routines.cancelled': 'cancelled',
  ...
  'routines.deleteTitle': 'Delete this routine',
  'routines.placeholderName': 'Morning briefing',

  'routines.loading': 'Loading…',
  'routines.noRoutinesYet': 'No routines yet.',
  'routines.noRoutinesHint': 'Click "New routine" to schedule an unattended agent run.',
