...
export interface Dict {
  ...
  'routines.newProject': string;
  'routines.existingProject': string;
  'routines.hourly': string;
  'routines.daily': string;
  'routines.weekdays': string;
  'routines.weekly': string;
  'routines.minuteOfHour': string;
  'routines.hour': string;
  'routines.dayOfWeek': string;
  'routines.time': string;
  'routines.sunday': string;
  'routines.monday': string;
  'routines.tuesday': string;
  'routines.wednesday': string;
  'routines.thursday': string;
  'routines.friday': string;
  'routines.saturday': string;
  'routines.sun': string;
  'routines.mon': string;
  'routines.tue': string;
  'routines.wed': string;
  ...
  'routines.fri': string;
  'routines.sat': string;
  'routines.succeeded': string;
  'routines.failed': string;
  'routines.running': string;
  'routines.cancelled': string;
  'routines.loadingRuns': string;
  'routines.noRuns': string;
  'routines.manual': string;
  'routines.scheduled': string;
  'routines.last': string;
  'routines.deleteConfirm': string;
  'routines.deleteTitle': string;
  'routines.placeholderName': string;
  'routines.loading': string;
  'routines.noRoutinesYet': string;
  'routines.noRoutinesHint': string;
